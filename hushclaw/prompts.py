...
TOOL_USE_GUIDANCE: str = (
    ...
    "- When making small edits to an existing Markdown, HTML, or text document, read the "
    "existing file and use patch_document with unique anchors so only the relevant section "
    "changes; use update_document for full-document rewrites or broad restructuring; "
...
SKILLS_GUIDANCE: str = (
    ...
    "patch_document for local edits to existing Markdown/HTML/text documents, or "
    "update_document for full-document rewrites, and never write to /files/... directly. "
