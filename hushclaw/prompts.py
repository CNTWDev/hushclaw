...
TOOL_USE_GUIDANCE: str = (
    ...
    "- When modifying an existing Markdown, HTML, or text document, read the existing file "
    "and use update_document so the original path is updated with a backup version; "
...
SKILLS_GUIDANCE: str = (
    ...
    "write_file with relative paths (for example, \"report.md\") for new files, or "
    "update_document when revising an existing Markdown/HTML/text document, and never write to /files/... directly. "
