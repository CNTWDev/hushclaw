        ...
        request = (
            ...
            .request_body(
                CreateMessageRequestBody.builder()
                    .receive_id(chat_id)
                    .msg_type("post" if rendered.format == "feishu_post" else "text")
                    .content(rendered.body if rendered.format == "feishu_post" else json.dumps({"text": rendered.body or rendered.plain_text}))
                    .build()
            )
            .build()
        )
