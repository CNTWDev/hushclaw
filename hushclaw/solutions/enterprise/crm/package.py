...
CRM_AGENT_DEFINITIONS: tuple[dict[str, Any], ...] = (
    {
        ...
        "routing_tags": ["partner_discovery", "market_signal_tracking", "prospect_creation"],
        "tools": [
            "crm.search_records",
            "crm.create_prospect",
            "crm.record_market_signal",
    ...
    },
    {
        ...
        "domain_id": "crm",
        "visibility": "employee_visible",
        "routing_tags": ["partner_fit_scoring", "prospect_qualification", "next_action"],
        "tools": [
            "crm.search_records",
            "crm.score_prospect",
            "crm.suggest_next_action",
    ...
    },
    {
        ...
        "domain_id": "crm",
        "visibility": "employee_visible",
        "routing_tags": ["account_context", "activity_review", "customer_research"],
        "tools": [
            "crm.search_records",
            "crm.record_market_signal",
            "crm.suggest_next_action",
    ...
    },
    {
        ...
        "domain_id": "crm",
        "visibility": "employee_visible",
        "routing_tags": ["followup_planning", "next_action", "activity_review"],
        "tools": [
            "crm.search_records",
            "crm.log_activity",
            "crm.suggest_next_action",
    ...
    },
    {
        ...
        "domain_id": "crm",
        "visibility": "employee_visible",
        "routing_tags": ["outbound_draft_generation", "partner_messaging"],
        "tools": [
            "crm.search_records",
            "crm.create_outbound_draft",
        ],
    ...
    },
    {
        ...
        "domain_id": "crm",
        "visibility": "employee_visible",
        "routing_tags": ["opportunity_review", "risk_signal", "next_action"],
        "tools": [
            "crm.search_records",
            "crm.log_activity",
            "crm.update_opportunity_stage",
