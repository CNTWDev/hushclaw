...
const LANGS = {
  en: {
    ...
    sint_google_calendar_oauth_hint: "Google Calendar requires OAuth 2.0 and cannot connect through this username/password form. The old Google CalDAV URL is deprecated. Connections → Google Workspace offers OAuth authorization only; it does not sync events into the Calendar view.",
  ...
  zh: {
    ...
    sint_google_calendar_oauth_hint: "Google Calendar 需要 OAuth 2.0，无法通过此用户名／密码表单连接，旧版 Google CalDAV 地址也已废弃。Connections → Google Workspace 目前仅提供 OAuth 授权，尚不会将日程同步到 Calendar 页面。",
